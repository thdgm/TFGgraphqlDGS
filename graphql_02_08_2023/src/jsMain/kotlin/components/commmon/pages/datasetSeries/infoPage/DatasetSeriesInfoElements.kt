                            ...
                            addToFilters = {
                                ...
                                selectedFilters =
                                    selectedFilters.toMutableMap().mapValues { (key, catalogMap) ->
                                        if (key == "DatasetSeries") {
                                            catalogMap!!.toMutableMap().mapValues { (innerKey, filterVal) ->
                                                if (innerKey == "Catalogos" && !filterVal.contains(it.catalogId)) filterVal.plus(it.catalogId)
                                                else if (filterVal.contains(it.catalogId)) filterVal.filter { miVal -> miVal != it.catalogId }
                                                else filterVal
                                            }.toMutableMap()
                                        } else {
                                            catalogMap
