...
interface RelationshipsRepository : JpaRepository<RelationshipsEntity, String> {
    fun findByIdCatalogAndTypes(idS: String, type: String): Collection<RelationshipsEntity?>
    fun findByIdCatalog(idS: String): Collection<RelationshipsEntity?>
    fun findByIdCatalogAndTypesNot(idS: String, type: String): Collection<RelationshipsEntity?>
}
