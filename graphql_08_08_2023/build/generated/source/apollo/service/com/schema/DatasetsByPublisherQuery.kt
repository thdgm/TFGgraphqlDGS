...
public data class DatasetsByPublisherQuery(
  ...
  public companion object {
    public const val OPERATION_ID: String =
        "73920d1c044bebe3caa4cd30888c3594c9b20fdfa9aa02a2ac56dd8e4a450977"
     ...
     *       }
     *       inCatalog {
     *         resources(page: $page, pageSize: 10, type: "data_service") {
     *           __typename
     *           ... on DataService {
     *             isAccessedBy {
     *               id
    ...
    public val OPERATION_DOCUMENT: String
      get() =
          "query DatasetsByPublisher(${'$'}filter: [MapInput!], ${'$'}page: Int!, ${'$'}isDataset: Boolean!) { resourcesByFilter(filters: ${'$'}filter, type: \"dataset\", isDataset: ${'$'}isDataset, isCatalog: false, isDataService: false, isDatasetSeries: false, page: ${'$'}page) { __typename ... on Dataset @include(if: ${'$'}isDataset) { id title distributions { format } inCatalog { resources(page: ${'$'}page, pageSize: 10, type: \"data_service\") { __typename ... on DataService { isAccessedBy { id } } } } } } }"
