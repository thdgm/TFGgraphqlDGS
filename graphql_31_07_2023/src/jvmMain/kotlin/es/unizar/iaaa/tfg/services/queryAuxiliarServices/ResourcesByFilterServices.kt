...
class ResourcesByFilterServicesImpl(
    ...
    fun getDatasetsByFilters(appliedFilters: List<MapInput>, type: String,page: Int,sortBy: String, orderBy: String?): Collection<Resource>{
        ...
        println("ORDERSORTBYYY3::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: $sortBy - $orderBy")
    ...
    fun getCatalogsByFilters(appliedFilters: List<MapInput>, type: String,page: Int, sortBy: String, orderBy: String?): Collection<Resource>{
        ...
        println("ORDERSORTBYYY::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: $sortBy - $orderBy")

        if (appliedFilters.isEmpty() || checkIfSelectedFiltersIsEmpty(appliedFilters)){
            //return resourceRepository.findAllCatalogs(PageRequest.of(page,10)).content.map { convertersResourcesEntitiesTo.createResource(it) }
        }
        println("NUMBERRRRRRRRRRRRERRRRRRERRRRRRERRRRRRERRRRRRERRRRRR::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: $numberOfResources")

        val res = repoCriteria.findCatalogsByFilters(appliedFilters,type,orderBy?.toUpperCase() ?: "ASC",sortBy,page,issued, modified, notation,numberOfResources) //resRepo.getResources(appliedFilters,type,page, issued, modified, period, notation).map { convertersResourcesEntitiesTo.createResource(it) }.distinct()
        return res?.map { convertersResourcesEntitiesTo.createResource(it) }?.distinct() ?: listOf()
    }
