...
class ResourceServicesImpl(
    ...
    override fun getTitles(id: String): Collection<LangString?> {
        ...
        val l = titleRepository.findByResourceTitleId(id)
            .map {
                println("GEEEETTTTTTTT TIIIITTLLLLLLLEEEEEEEEEEEEEEESSSSSSSSSSSS2.1 ${it.id} -- ${languageRepository.findLanguagesResourcesByTitlesResourceIdTitleId(it.id.titleId)}")
                ...
                languageRepository.findLanguagesResourcesByTitlesResourceIdTitleId(it.id.titleId)
                    .forEach {
                        ...
                        println("GEEEETTTTTTTT TIIIITTLLLLLLLEEEEEEEEEEEEEEESSSSSSSSSSSS3.2 ${converterAuxiliar.toLangString(title.id.titleId + LANGSTRING_SEPARADOR + it.id)}")
    ...
    override fun getDescriptions(id: String): Collection<LangString?> {
        println("ESTO TENGO: ${descriptionRepository.findByResourceId(id)}")
    ...
    override fun getTheme(id: String): Collection<String?> {
        println("GEEEEEEETTTTTTTTT THEEEEEEMMMMMMMMEEEEESSSSSSSSS ${themeRepository.findThemeByResourcesId(id)}")
