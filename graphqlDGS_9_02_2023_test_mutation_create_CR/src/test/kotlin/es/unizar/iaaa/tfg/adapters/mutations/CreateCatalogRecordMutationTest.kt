...
class CreateCatalogRecordMutationTest {
    ...
    fun `Creo CR a partir de json y tiene inCatalog records id su id`() {
        ...
        val createCR = dgsQueryExecutor.executeAndGetDocumentContext(query, crInput)
        val response = GraphQLResponse(createCR.jsonString())
        val records = response.extractValue<Collection<String>>("data.createCatalogRecord.primaryTopic.inCatalog[*].records[*].id")
    ...
    fun `El CR tiene primaryTopic a un dataset cuyo primaryTopic es dicho CR`() {
        ...
        val createCR = dgsQueryExecutor.executeAndGetDocumentContext(query, crInput)
        val response = GraphQLResponse(createCR.jsonString())
        val primaryTopicOf = response.extractValue<Collection<String>>("data.createCatalogRecord.primaryTopic.isPrimaryTopicOf[*].id")
    ...
    fun `El CR tiene primaryTopic a un dataset compruebo su title keywords y language`() {
        ...
        val createCR = dgsQueryExecutor.executeAndGetDocumentContext(query, crInput)
        val response = GraphQLResponse(createCR.jsonString())
        val keywords = response.extractValue<Collection<String>>("data.createCatalogRecord.primaryTopic.keywords[*].tag")
    ...
    fun `El CR tiene primaryTopic a un dataset compruebo su description`() {
        ...
        val createCR = dgsQueryExecutor.executeAndGetDocumentContext(query, crInput)
        val response = GraphQLResponse(createCR.jsonString())
        val descriptionLanguage = response.extractValue<Collection<String>>("data.createCatalogRecord.primaryTopic.description[*].tag")
    ...
    fun `El CR tiene primaryTopic a un dataset compruebo su spatial y accrualPeriodicity no tiene en este caso`() {
        ...
        val accrualPeriodicity = response.extractValue<String>("data.createCatalogRecord.primaryTopic.accrualPeriodicity")
    ...
    fun `El CR tiene primaryTopic a un dataset compruebo sus distributions fields title, accessUrl, tienen 2`() {
        ...
        val createCR = dgsQueryExecutor.executeAndGetDocumentContext(query, crInput)
        val response = GraphQLResponse(createCR.jsonString())
        val title = response.extractValue<Collection<String>>("data.createCatalogRecord.primaryTopic.distributions[*].title[*]")
        val accessUrl = response.extractValue<Collection<String>>("data.createCatalogRecord.primaryTopic.distributions[*].accessUrl")
    ...
    fun `El CR tiene primaryTopic a un dataset compruebo sus distributions accessService id es el dataset`() {
        ...
        val servesDataset = response.extractValue<Collection<String>>("data.createCatalogRecord.primaryTopic.distributions[*].accessService[*].servesDataset[*].id")
