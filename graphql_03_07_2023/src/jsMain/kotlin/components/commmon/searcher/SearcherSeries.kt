...
import components.commmon.pages.datasetSeries.mainPage.IsLoadingContext
...
external interface SearcherSeriesProps:Props{
    var filterList: Collection<SeriesModel>
    var handleOnChange: (event: ChangeEvent<HTMLElement>) -> Unit

}

val SearcherSeries = FC<SearcherSeriesProps> { props->
