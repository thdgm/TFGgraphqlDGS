        ...
        Box {
            CardContent{
                ...
                Typography {
                    ...
                    if(!props.crInfo.primaryTopic?.resourceIdentifier.isNullOrEmpty()){
                        +"Recurso representado: ${props.crInfo.primaryTopic?.resourceIdentifier?.elementAt(0)}"
                    }else{
                        +"Recurso representado: ${props.crInfo.primaryTopic?.resourceId}"
                    }
