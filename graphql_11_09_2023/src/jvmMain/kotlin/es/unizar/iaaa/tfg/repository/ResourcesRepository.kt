...
class ResourceRepositoryExtra(){
    ...
    fun findNumberOfDatasetsByFilters(
        ...
        val periods = period
        val keywords = appliedFilters.find { it.key == "Etiquetas más comunes" }?.values ?: listOf()
        ...
        var queryString = "SELECT COUNT (DISTINCT result.id) FROM " +
                "(SELECT DISTINCT tt.id, tt.tipo, tt.issued, tt.license, tt.modified, tt.publisher_id, tt.accrual_periodicity, " +
        ...
        println("QUERYYYYY_::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: $queryString")
    ...
    fun findCatalogsByFilters(
        ...
        var queryString = "SELECT DISTINCT tt.id, tt.tipo, tt.issued, tt.license, tt.modified, tt.publisher_id, tt.accrual_periodicity, " +
                "tt.temporal_coverage_end, tt.temporal_coverage_start, tt.validity " +
                "FROM catalogs_by_filter tt WHERE "
        if (notation.isNotEmpty()) {
            notation.mapIndexed { index, _ ->
                if (index == notation.size-1 && notation.size > 1) queryString += "tt.notation LIKE :notation$index ESCAPE '') OR "
                else if (index == 0 && notation.size > 1)  queryString += "(tt.notation LIKE :notation$index ESCAPE '' OR "
    ...
    fun findServicesByFilters(
        ...
        var queryString = "SELECT DISTINCT tt.id, tt.tipo, tt.issued, tt.license, tt.modified, tt.publisher_id, tt.accrual_periodicity, " +
                "tt.temporal_coverage_end, tt.temporal_coverage_start, tt.validity " +
                "FROM services_by_filter tt WHERE "
        if (notation.isNotEmpty()) {
            notation.mapIndexed { index, _ ->
                if (index == notation.size-1 && notation.size > 1) queryString += "tt.notation LIKE :notation$index ESCAPE '') OR "
                else if (index == 0 && notation.size > 1)  queryString += "(tt.notation LIKE :notation$index ESCAPE '' OR "
    ...
    fun findServicesNumberByFilters(
        filters: Collection<MapInput>,
        type: String,
        issued: List<LocalDateTime>,
        modified: List<LocalDateTime>,
        ...
        /*var queryString = "SELECT DISTINCT tt.id, tt.tipo, tt.issued, tt.license, tt.modified, tt.publisher_id,tt.accrual_periodicity, tt.temporal_coverage_end, tt.temporal_coverage_start, tt.validity  FROM ( " +
                ...
                "LEFT JOIN description descr ON r.id = descr.id_resource) as tt " +
                "WHERE tt.tipo = 'data_service' AND "*/
        var queryString = "SELECT (DISTINCT COUNT result.id) FROM (SELECT DISTINCT tt.id, tt.tipo, tt.issued, tt.license, tt.modified, tt.publisher_id, tt.accrual_periodicity, " +
                "tt.temporal_coverage_end, tt.temporal_coverage_start, tt.validity " +
                "FROM services_by_filter tt WHERE "
        if (notation.isNotEmpty()) {
            notation.mapIndexed { index, _ ->
    ...
    fun findSeriesByFilters(
        ...
        var queryString = "SELECT DISTINCT tt.id, tt.tipo, tt.issued, tt.license, tt.modified, tt.publisher_id, tt.accrual_periodicity, " +
                "tt.temporal_coverage_end, tt.temporal_coverage_start, tt.validity " +
                "FROM series_by_filter tt WHERE "
        if (notation.isNotEmpty()) {
            notation.mapIndexed { index, _ ->
                if (index == notation.size-1 && notation.size > 1) queryString += "tt.notation LIKE :notation$index ESCAPE '') OR "
                else if (index == 0 && notation.size > 1)  queryString += "(tt.notation LIKE :notation$index ESCAPE '' OR "
    ...
    fun findResourcesNumber(type: String): Long?{
        var queryString = when (type) {
            "dataset" -> "SELECT * FROM number_of_datasets"
            "catalog" -> "SELECT * FROM number_of_catalogs"
            "data_service" -> "SELECT * FROM number_of_services"
            "dataset_series" -> "SELECT * FROM number_of_series"
            else -> ""
        }
        println("QUERYYYYY_::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: $queryString")
    ...
    fun findDistributionsByFilters(
        ...
        /*var queryString = "SELECT DISTINCT tt.id, tt.access_url, tt.byte_size, tt.format FROM ( " +
                ...
                "WHERE "*/
        var queryString = "SELECT DISTINCT tt.id, tt.access_url, tt.byte_size, tt.format " +
                "FROM distributions_by_filter tt WHERE "
    ...
    fun findCatalogRecordsByFilters(
        ...
        /*var queryString = "SELECT DISTINCT tt.id, tt.content, tt.content_type, tt.content_url, tt.title, tt.resource_id FROM ( " +
                ...
                "WHERE "*/
        var queryString = "SELECT DISTINCT tt.id, tt.content, tt.content_type, tt.content_url, tt.title, tt.resource_id " +
                "FROM records_by_filter tt WHERE "
    ...
    fun findNumberOfCRByFilter(
        ...
        /*var queryString = "SELECT COUNT(DISTINCT result.id) as total_elements FROM " +
                ...
                "LEFT JOIN hints h ON h.id_catalog_record = cr.id) as tt " +
                " WHERE "*/
        var queryString = "SELECT COUNT (DISTINCT result.id) FROM (SELECT DISTINCT tt.id, tt.content, tt.content_type, tt.content_url, tt.title, tt.resource_id " +
                "FROM records_by_filter tt WHERE "
        if (formats.isNotEmpty()) queryString += "tt.content_type IN :formats OR "
        if (hints.isNotEmpty()) queryString += "tt.hints IN :hints OR "
        if (titles.isNotEmpty()) queryString += "tt.title IN :titles OR "
