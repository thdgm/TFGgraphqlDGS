...
public object DatasetInfoQuery_ResponseAdapter {
  ...
  public object Distribution : Adapter<DatasetInfoQuery.Distribution> {
    public val RESPONSE_NAMES: List<String> = listOf("id", "accessUrl", "format")
    ...
    public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
      ...
      while(true) {
        when (reader.selectName(RESPONSE_NAMES)) {
          0 -> _id = StringAdapter.fromJson(reader, customScalarAdapters)
          1 -> _accessUrl = NullableStringAdapter.fromJson(reader, customScalarAdapters)
          2 -> _format = commonModels.mediaTypeAdapter.nullable().fromJson(reader,
              customScalarAdapters)
          else -> break
        }
      }
