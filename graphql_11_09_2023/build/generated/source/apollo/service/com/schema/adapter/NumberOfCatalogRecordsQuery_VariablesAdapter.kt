...
public object NumberOfCatalogRecordsQuery_VariablesAdapter : Adapter<NumberOfCatalogRecordsQuery> {
  public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
      NumberOfCatalogRecordsQuery = throw
      IllegalStateException("Input type used in output position")

  public override fun toJson(
    writer: JsonWriter,
    customScalarAdapters: CustomScalarAdapters,
    `value`: NumberOfCatalogRecordsQuery,
  ): Unit {
