...
class LanguageEntity {
    ...
    @JoinTable(
        ...
        joinColumns = [JoinColumn(name = "id_language")],
        inverseJoinColumns = [JoinColumn(name = "id_description"),JoinColumn(name = "id_resource")],
    )
...
/*
    @OneToMany(mappedBy = "language")
    lateinit var titlesDistribution: Collection<TitlesDistributionEntity>

    @OneToMany(mappedBy = "language")
    lateinit var titlesResource: Collection<TitlesResourceEntity>*/
