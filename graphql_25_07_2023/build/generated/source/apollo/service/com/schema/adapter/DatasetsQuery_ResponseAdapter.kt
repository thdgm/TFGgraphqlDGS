...
public object DatasetsQuery_ResponseAdapter {
  ...
  public object ResourcesByFilter : Adapter<DatasetsQuery.ResourcesByFilter> {
    ...
    public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
      ...
      var _onCatalog: DatasetsQuery.OnCatalog? = null
      if (and(possibleTypes("Catalog"),variable("isCatalog")).evaluate(customScalarAdapters.adapterContext.variables(), __typename, customScalarAdapters.adapterContext, null)) {
        reader.rewind()
        _onCatalog = com.schema.adapter.DatasetsQuery_ResponseAdapter.OnCatalog.fromJson(reader,
            customScalarAdapters)
      }
  ...
  public object OnCatalog : Adapter<DatasetsQuery.OnCatalog> {
    public val RESPONSE_NAMES: List<String> = listOf("id", "title", "description", "issued",
        "modified", "numberOfResources")

    public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
        DatasetsQuery.OnCatalog {
      var _id: String? = null
      var _title: List<LangStringAdapterScalar>? = null
      var _description: List<LangStringAdapterScalar>? = null
      ...
      return DatasetsQuery.OnCatalog(
        id = _id!!,
        title = _title,
        description = _description,
        issued = _issued,
