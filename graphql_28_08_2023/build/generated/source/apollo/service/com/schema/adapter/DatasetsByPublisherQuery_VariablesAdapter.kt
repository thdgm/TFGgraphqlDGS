...
public object DatasetsByPublisherQuery_VariablesAdapter : Adapter<DatasetsByPublisherQuery> {
  public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
      DatasetsByPublisherQuery = throw IllegalStateException("Input type used in output position")

  public override fun toJson(
    writer: JsonWriter,
    customScalarAdapters: CustomScalarAdapters,
    `value`: DatasetsByPublisherQuery,
  ): Unit {
