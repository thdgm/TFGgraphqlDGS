                    ...
                    FormLabel {
                        filterInfo{
                            ...
                            this.updateFilterListMore = {filtersTypesFields = mutableListOf(
                                ...
                                if (value == "Publicador") getAllPublishers(false) else filtersTypesFields.elementAt(2),
                                if (value == "Nivel de Administración") getAllAdminLevels(false) else filtersTypesFields.elementAt(3),
                                if (value == "Frecuencia de Actualización") getAllFrequencies(false) else filtersTypesFields.elementAt(4),
                            ...
                            this.updateFilterListLess = {filtersTypesFields = mutableListOf(
                                ...
                                if (value == "Publicador") getAllPublishers(true) else filtersTypesFields.elementAt(2),
                                if (value == "Nivel de Administración") getAllAdminLevels(true) else filtersTypesFields.elementAt(3),
                                if (value == "Frecuencia de Actualización") getAllFrequencies(true) else filtersTypesFields.elementAt(4),
