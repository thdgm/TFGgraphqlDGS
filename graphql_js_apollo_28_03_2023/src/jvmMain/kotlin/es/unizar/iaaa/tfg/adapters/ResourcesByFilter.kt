...
class ResourcesByFilter(
    ...
    @DgsQuery
    fun resourcesByFilter(@InputArgument filter: String?, @InputArgument value: Collection<String>): Collection<Resource?>{
        if (filter == null || value == null) {
            return emptyList()
        }
        return resourcesByFilterServices.getResourcesByField(filter,value)
    }
