...
class FilterFieldsQueries(
    ...
    // @DgsQuery getAllContentTypes: returns all existing content types without duplicates
    @DgsQuery
    fun getAllContentTypes(@InputArgument page: Int, @InputArgument pageSize: Int): Collection<String> =
        fieldsFilterServices.getContentTypes(page,pageSize)


    // @DgsQuery getAllHints: returns all existing hints without duplicates
    @DgsQuery
    fun getAllHints(@InputArgument page: Int, @InputArgument pageSize: Int): Collection<String> =
        fieldsFilterServices.getHints(page,pageSize)
