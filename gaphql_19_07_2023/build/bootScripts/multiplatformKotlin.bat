...
set JARPATH=%APP_HOME%\lib\multiplatformKotlin-1.0-SNAPSHOT.jar

@rem Execute multiplatformKotlin
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MULTIPLATFORM_KOTLIN_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%MULTIPLATFORM_KOTLIN_EXIT_CONSOLE%" exit 1
exit /b 1
