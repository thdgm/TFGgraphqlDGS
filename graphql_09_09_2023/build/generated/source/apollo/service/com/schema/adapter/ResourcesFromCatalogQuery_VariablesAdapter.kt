...
public object ResourcesFromCatalogQuery_VariablesAdapter : Adapter<ResourcesFromCatalogQuery> {
  public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
      ResourcesFromCatalogQuery = throw IllegalStateException("Input type used in output position")

  public override fun toJson(
    writer: JsonWriter,
    customScalarAdapters: CustomScalarAdapters,
    `value`: ResourcesFromCatalogQuery,
  ): Unit {
    writer.name("id")
