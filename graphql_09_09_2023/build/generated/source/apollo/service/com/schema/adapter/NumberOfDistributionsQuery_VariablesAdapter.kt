...
public object NumberOfDistributionsQuery_VariablesAdapter : Adapter<NumberOfDistributionsQuery> {
  public override fun fromJson(reader: JsonReader, customScalarAdapters: CustomScalarAdapters):
      NumberOfDistributionsQuery = throw IllegalStateException("Input type used in output position")

  public override fun toJson(
    writer: JsonWriter,
    customScalarAdapters: CustomScalarAdapters,
    `value`: NumberOfDistributionsQuery,
  ): Unit {
