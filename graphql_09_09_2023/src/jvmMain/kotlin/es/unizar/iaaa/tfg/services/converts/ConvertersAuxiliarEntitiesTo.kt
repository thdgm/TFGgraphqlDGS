...
interface ConvertersAuxiliarEntitiesTo {
    ...
    fun toPublisherOutput(publisher: PublisherEntity): PublisherOutput
...
class ConvertersAuxiliarEntitiesToImpl : ConvertersAuxiliarEntitiesTo {
    ...
    // Convert Publisher entity into PublisherOutput format
    override fun toPublisherOutput(publisher: PublisherEntity): PublisherOutput =
        PublisherOutput(publisher.notation, publisher.label, emptyList())
