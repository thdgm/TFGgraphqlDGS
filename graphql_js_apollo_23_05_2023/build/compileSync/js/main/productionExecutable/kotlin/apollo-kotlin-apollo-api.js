(function (root, factory) {
  ...
  var isInfinite = kotlin_kotlin.$_$.w9;
  ...
  Element.prototype.toString = function () {
    return 'Element(value=' + this.c2d_1 + ')';
  };
  ...
  function BPossibleTypes(possibleTypes) {
    BTerm.call(this);
    this.d2d_1 = possibleTypes;
  }
  BPossibleTypes.prototype.toString = function () {
    return 'BPossibleTypes(possibleTypes=' + this.d2d_1 + ')';
  };
    ...
    if (equals(tmp0_subject, True_getInstance())) {
      ...
      if (equals(tmp0_subject, False_getInstance())) {
        ...
        if (tmp0_subject instanceof Not) {
          tmp = !evaluate_0(_this__u8e3s4.g2d_1, block);
        } else {
          if (tmp0_subject instanceof Or) {
            var tmp$ret$0;
            $l$block_0: {
              // Inline function 'kotlin.collections.any' call
              var tmp0_any = _this__u8e3s4.f2d_1;
              var tmp_0;
            ...
            if (tmp0_subject instanceof And) {
              ...
              $l$block_2: {
                ...
                var tmp1_all = _this__u8e3s4.e2d_1;
                var tmp_1;
  ...
  function evaluate$lambda($variables, $adapterContext, $croppedPath, $typename) {
    return function (it) {
      ...
      if (tmp0_subject instanceof BVariable) {
        tmp = !$variables.n(it.i2d_1);
      } else {
        if (tmp0_subject instanceof BLabel) {
          tmp = $adapterContext.g29(ensureNotNull($croppedPath), it.h2d_1);
        } else {
          if (tmp0_subject instanceof BPossibleTypes) {
            tmp = contains(it.d2d_1, $typename);
          } else {
            noWhenBranchMatchedException();
          }
        }
  ...
  BufferedSourceJsonReader.prototype.m = function () {
    var tmp$ret$1;
    // Inline function 'kotlin.takeUnless' call
    var tmp0_takeUnless = this.f2h_1;
    // Inline function 'kotlin.contracts.contract' call
  ...
  MapJsonReader.prototype.m = function () {
  ...
  _.$_$.n = Builder_2;
  _.$_$.o = DeferredFragmentIdentifier;
  _.$_$.p = fold;
  _.$_$.q = get;
  _.$_$.r = minusKey;
  _.$_$.s = Element_0;
