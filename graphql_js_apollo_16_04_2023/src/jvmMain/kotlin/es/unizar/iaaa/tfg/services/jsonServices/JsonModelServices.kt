...
class JsonModelServicesImpl(
    ...
    /*
     * After process the JSON file, if we read a JSONArray value
     * we will obtain all the required fields in this service.
     */
    ...
    /*
    * After process the JSON file, if we read a JSONObject value
    * we will obtain all the required fields in this service.
    */
    ...
    /*
    * After process the JSON file, if we read a String value
    * we will obtain all the required fields in this service.
    */
    ...
    /*
    * This service is responsible for create the
    * objects which helps to create the model and entities.
    * Overall, it records the required fields in different data classes.
    */
    ...
    /*
      * The following services create the different models
      * mentioned before. Using the fields read in the JSON file
      */
